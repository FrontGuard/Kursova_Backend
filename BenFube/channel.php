...
$stmt = $conn->prepare("SELECT videos.*, COUNT(video_views.id) AS view_count
                        FROM videos
        ...
        <?php if ($videos): ?>
            <?php foreach ($videos as $video): ?>
                <div class="video-card">
                    ...
                    <p>Кількість переглядів: <?php echo htmlspecialchars($video['view_count']); ?></p>
                    <?php if (!empty($video['preview_image_path'])): ?>
                        <a href="video_view_comments.php?id=<?php echo htmlspecialchars($video['id']); ?>">
                            <img src="<?php echo htmlspecialchars($video['preview_image_path']); ?>" alt="Preview" class="video-preview" width="370" height="290">
                        </a>
                    <?php endif; ?>
